  ...
  <ActionSection>
    ...
    <template #content>
      ...
      <div class="mt-3 max-w-xl text-sm text-gray-600 dark:text-gray-400">
        <p>
          Quando a autenticação de dois fatores estiver ativada, será solicitado
          um token aleatório e seguro durante a autenticação. Você pode
          recuperar esse token no aplicativo Google Authenticator do seu
          telefone.
        </p>
      </div>
        ...
        <div v-if="qrCode">
          <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p v-if="confirming" class="font-semibold">
              Para concluir a ativação da autenticação de dois fatores, leia o
              seguinte QR code usando o aplicativo autenticador do seu telefone
              ou insira a chave de configuração e forneça o código OTP gerado.
            </p>

            <p v-else>
              A autenticação de dois fatores agora está habilitada. Digitalize o
              seguinte QR code usando o aplicativo autenticador do seu telefone
        ...
        <div v-if="recoveryCodes.length > 0 && !confirming">
          <div class="mt-4 max-w-xl text-sm text-gray-600 dark:text-gray-400">
            <p class="font-semibold">
              ...
              seguro. Eles podem ser usados para recuperar o acesso à sua conta
              se o seu dispositivo de autenticação de dois fatores for perdido.
            </p>
          </div>
