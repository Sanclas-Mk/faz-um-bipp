...
<template>
  <ActionSection>
    ...
    <template #description>
      Gerencie e efetue logout de suas sessões ativas em outros navegadores e
      dispositivos.
    </template>
    ...
    <template #content>
      ...
      <DialogModal :show="confirmingLogout" @close="closeModal">
        ...
        <template #content>
          Por favor, digite sua senha para confirmar que deseja sair do suas
          outras sessões do navegador em todos os seus dispositivos.
