...
import SessaoInicio from "@/Components/HomeC/SessaoInicio.vue";
import SessaoServicos from "@/Components/HomeC/SessaoServicos.vue";
import SessaoPlanos from "@/Components/HomeC/SPlanos/SessaoPlanos.vue";
...
<template>
  ...
  <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50 hidden">
    <img
      id="background"
