...
<template>
  <SiteLayout>
    <div class="max-sm:px-10 max-sm:pt-10 px-20 pt-14 pb-10 text-justify">
      <h2 class="text-[20px] pb-6">Políticas de Privacidade Bipp</h2>
      <p class="py-2" style="color: rgb(68, 68, 68)">
        A sua privacidade é importante para nós. É política do Bipp respeitar a
        sua privacidade em relação a qualquer informação sua que possamos
        coletar no site <a href="https://bipp.com.br">Bipp</a>, e outros sites
      ...
      <p class="py-2">
        <span style="color: rgb(68, 68, 68)"
          ...
          informações pessoais, entre em contacto connosco.</span
        >
      </p>
      <p class="py-2">
        <span style="color: rgb(68, 68, 68)"
      ...
      <h3 class="text-[20px] pb-6">Compromisso do Usuário</h3>
      <p class="py-2">
        <span style="color: rgb(68, 68, 68)"
          >O usuário se compromete a fazer uso adequado dos conteúdos e da
          informação que o Bipp oferece no site e com caráter enunciativo, mas
          não limitativo:</span
        >
      </p>
      <ul>
        ...
        <li>
          <span style="color: rgb(68, 68, 68)"
            ...
            (softwares) do Bipp, de seus fornecedores ou terceiros, para
      ...
      <h3 class="text-[20px] py-6">Mais informações</h3>
      <p class="py-2">
        <span style="color: rgb(68, 68, 68)"
